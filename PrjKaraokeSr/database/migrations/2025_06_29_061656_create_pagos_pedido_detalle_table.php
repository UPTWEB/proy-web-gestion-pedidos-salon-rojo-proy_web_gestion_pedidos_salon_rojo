...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pagos_pedido_detalle', function (Blueprint $table) {
            ...
            $table->enum('metodo_pago', ['EFECTIVO', 'TARJETA_CREDITO', 'TARJETA_DEBITO', 'YAPE', 'PLIN', 'TRANSFERENCIA'])->index('idx_pagos_pedido_detalle_metodo_pago')->comment('Método de pago específico utilizado para esta porción del ítem del pedido.');
